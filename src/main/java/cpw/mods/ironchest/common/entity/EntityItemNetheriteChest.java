...
public class EntityItemNetheriteChest extends EntityItem {
    //Taken from https://github.com/Jboymercs/nether_backport/blob/20b89ea14bd43c244c63675b028b8a7cdb887cfa/src/main/java/com/unseen/nb/common/entity/entities/EntityItemNetheriteChest.java
    private int age;
    private int pickupDelay;
    private int health;

    public EntityItemNetheriteChest(World worldIn) {
        super(worldIn);
        this.health = 5;
    ...
    public EntityItemNetheriteChest(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.health = 5;
    ...
    public EntityItemNetheriteChest(World worldIn, double x, double y, double z, ItemStack stack) {
        super(worldIn, x, y, z, stack);

        this.isImmuneToFire = true;
    }

    public EntityItemNetheriteChest(World worldIn, EntityItem itemIn, ItemStack stack) {
    ...
    private boolean combineItems(EntityItemNetheriteChest other) {
        if (other == this) {
            return false;
